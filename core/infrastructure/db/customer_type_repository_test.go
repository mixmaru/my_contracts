...
func TestCustomerTypeRepository_Create(t *testing.T) {
	...
	//	}
	//
	//	customerType := customer.NewCustomerTypeEntity("顧客名"+timestampstr, customerProperties)
	//
	//	////// 実行
	...
	//		gotSavedId, err := r.Create(tt.args.customerTypeEntity, tt.args.executor)
	//		if (err != nil) != tt.wantErr {
	//			t.Errorf("Create() error = %v, wantErr %v", err, tt.wantErr)
	//			return
	//		}
	//		if gotSavedId != tt.wantSavedId {
	//			t.Errorf("Create() gotSavedId = %v, want %v", gotSavedId, tt.wantSavedId)
	//		}
	//	})
	//}
}
